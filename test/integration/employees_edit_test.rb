...
class EmployeesEditTest < ActionDispatch::IntegrationTest
  ...
  test "unsuccessful edit" do
    ...
    get edit_employee_path(@employee)
    assert_template 'employees/edit'
    patch employee_path(@employee), params: { employee: { employer_id: 0,
# oare aici ii ok daca pun employer_id, desi ala teoretic ii blocat la editare? oare employer_id trebe scris cu ghilimele?
                                                        first_name:  "",
                                                        last_name: "" } }
    assert_template 'employees/edit'
  end
  ...
  test "successful edit with friendly forwarding" do
    ...
    first_name  = "Foo"
    last_name = "Bar"
    patch employee_path(@employee), params: { employee: { first_name:  first_name, last_name: last_name } }
